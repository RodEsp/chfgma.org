    ...
    <div className="footer">
        <div className="content-wrapper">
            <div className="stay-connected">
                ...
                <div><a href={MUTUAL_AID_NEWSLETTER_SUBSCRIBE_LINK} alt={`subscribe to newsletter link: ${MUTUAL_AID_NEWSLETTER_SUBSCRIBE_LINK}`}>Subscribe</a> to our weekly newsletter</div>
                <div><a href={MUTUAL_AID_SLACK_LINK} alt={`slack link: ${MUTUAL_AID_SLACK_LINK}`}>Join</a> us on Slack</div>
            </div>
