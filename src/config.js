...
export const MUTUAL_AID_NEWSLETTER_SUBSCRIBE_LINK = "https://notion.us19.list-manage.com/subscribe?u=a2f7efb31fe0c09ee5856bacb&id=9db6a5352a";
export const MUTUAL_AID_SLACK_LINK = "https://chfgmutualaid.slack.com/join/shared_invite/zt-dol9r5tu-Af~7Y5IIpCW17oOL~wBa1A#/";
export const MUTUAL_AID_PHONE_NUMBER_COUNTRY_CODE = "+1",
    MUTUAL_AID_PHONE_NUMBER = "862-277-0747";
export const MUTUAL_AID_EMAIL_ADDRESS_HELLO = "hello@chfgma.org";
export const MUTUAL_AID_INSTAGRAM_LINK = "https://www.facebook.com/chfgaid/",
    MUTUAL_AID_FACEBOOK_LINK = "https://www.instagram.com/chfgaid/";
export const MUTUAL_AID_AIRTABLE_LINK = "https://airtable.com/shrAwewkpHBHWyh5L/tbl4xknvSOLNB7bcI";
